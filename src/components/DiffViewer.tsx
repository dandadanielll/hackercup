...
export const DiffViewer: React.FC<DiffViewerProps> = ({ data, onUpdateLocalizedText }) => {
  ...
  const handleSaveEdit = () => {
    ...
    // Replace first occurrence of oldText in data.localized
  ...
  const handleRestoreOriginal = () => {
    ...
    // Replace localized text with original
  ...
  return (
    <div id="diff-viewer" className="bg-white rounded-xl shadow-xs border border-slate-200 p-5 sm:p-6 mb-8">
      {/* Top Header Bar */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Left Pane: Original Lesson Plan */}
        <div className="flex flex-col bg-slate-50 rounded-lg border border-slate-200 overflow-hidden shadow-2xs">
        ...
        {/* Right Pane: Localized Lesson Plan with Green Highlights */}
        <div className="flex flex-col bg-emerald-50/20 rounded-lg border border-emerald-200/90 overflow-hidden shadow-2xs relative">
      ...
      {/* Modal / Popover: Click to Edit Substitution */}
      {editingSegment && (
            ...
            <div className="py-4 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 text-xs font-mono border border-indigo-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 rounded-md outline-none"
